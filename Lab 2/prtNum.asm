...
printPos:
    ...
    mov AL, AH     ; FIXED Should copy number to be printed into register AL
    add AL, 30h    ; FIXED Should add required offset to convert number to ASCII representation
